  ...
  <div class="container">
    ...
    <form action="" method="post">
      <div class="form-group">
        ...
        <input type="text" name="firstName" class="form-control <?php echo isset($errors['firstName']) ? 'is-invalid' : '' ?>" value="<?=$firstName ?? ''?>">
...
?>
      ...
      <div class="form-group">
        ...
        <input type="text" name="lastName" class="form-control <?php echo isset($errors['lastName']) ? 'is-invalid' : '' ?>" value="<?=$lastName ?? ''?>">
        <small class="invalid-feedback">
        <?php
...
?>
      ...
      <div class="form-group">
        ...
        <input type="password" name="cpassword" class="form-control <?php echo isset($errors['cpassword']) ? 'is-invalid' : '' ?>">
        <small class="invalid-feedback">
        <?php
